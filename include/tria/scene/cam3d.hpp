...
public:
  Cam3d() = delete;
  Cam3d(math::Vec3f pos, math::Quatf rot, float fovDeg, float near, float far) :
      m_pos{pos}, m_rot{rot}, m_fov{fovDeg * math::degToRad<float>}, m_near{near}, m_far{far} {}

  [[nodiscard]] auto pos() const noexcept -> const math::Vec3f& { return m_pos; }
  [[nodiscard]] auto pos() noexcept -> math::Vec3f& { return m_pos; }

  [[nodiscard]] auto rot() const noexcept -> const math::Quatf& { return m_rot; }
  [[nodiscard]] auto rot() noexcept -> math::Quatf& { return m_rot; }

  [[nodiscard]] auto getRight() const noexcept { return m_rot * math::dir3d::right(); }
  [[nodiscard]] auto getUp() const noexcept { return m_rot * math::dir3d::up(); }
  [[nodiscard]] auto getFwd() const noexcept { return m_rot * math::dir3d::forward(); }
  ...
  [[nodiscard]] auto getViewMat() const noexcept {
    return math::rotMat4f(m_rot.getInv()) * math::transMat4f(m_pos * -1);
  }
